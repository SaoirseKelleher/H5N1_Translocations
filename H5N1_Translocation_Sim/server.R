...
function(input, output, session) {
  ...
  # Plot projected wild population (baseline page)
  ...
  # Plot projected wild and captive populations (translocation pages)
  ...
  # Plot projected survival rates (baseline page)
  ...
  # Plot projected survival rates (translocations page)
  ...
  # Plot projected translocation success rates
  ...
  # Run baseline simulation when button is pushed
  ...
  # Run translocation simulation when button is pushed
  ...
  # Run optimiser when button is pushed
  optimised <- reactive({
